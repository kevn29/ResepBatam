...
public class DBHelper extends SQLiteOpenHelper{
	...
	private final String RECIPE_NAME = "nama_resep";
	private final String IMAGE_PREVIEW = "gambar";
	private final String PREP_TIME = "waktu_persiapan";
	private final String COOK_TIME = "waktu_memasak";
	private final String SERVES = "penyajian";
	private final String SUMMARY = "deskrip";
	private final String INGREDIENTS = "bahan";
	private final String DIRECTIONS = "langkah_penyajian";
	...
	public ArrayList<ArrayList<Object>> getAllData(String RecipeNameKeyword){
		...
		if(RecipeNameKeyword.equals("")) {
			try {
				cursor = db.query(
						TABLE_NAME,
						new String[]{ID, RECIPE_NAME, IMAGE_PREVIEW, COOK_TIME, PREP_TIME},
